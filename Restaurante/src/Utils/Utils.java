...
public class Utils {
	...
	// en esta clase están los datos y funciones para que puedan ser llamados por cualquier agente 
	...
	// se envía un broadcast a todos los agentes con un rol en especifico, en envío contiene data y la guarda que le responderá
	public static void broadcast(AdmBESA admLocal, String rol, String guardaRespuesta, DataBESA data )
	{
	...
	// dado un id y una data, se crea un evento y se le envía al agente correspondiente a el id
